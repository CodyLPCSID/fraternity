...
import com.fraternity.fsp.domain.Location;
import com.fraternity.fsp.repository.LocationRepository;
...
public class LocationResourceIntTest {
    ...
    private static final String DEFAULT_NB_STREET = "AAAAAAAAAA";
    private static final String UPDATED_NB_STREET = "BBBBBBBBBB";

    private static final String DEFAULT_ZIP_CODE = "AAAAAAAAAA";
    private static final String UPDATED_ZIP_CODE = "BBBBBBBBBB";

    private static final String DEFAULT_LONGITUTE = "AAAAAAAAAA";
    private static final String UPDATED_LONGITUTE = "BBBBBBBBBB";
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location()
            ...
            .nbStreet(DEFAULT_NB_STREET)
            .zipCode(DEFAULT_ZIP_CODE)
            .longitute(DEFAULT_LONGITUTE)
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getNbStreet()).isEqualTo(DEFAULT_NB_STREET);
        assertThat(testLocation.getZipCode()).isEqualTo(DEFAULT_ZIP_CODE);
        assertThat(testLocation.getLongitute()).isEqualTo(DEFAULT_LONGITUTE);
    ...
    public void getAllLocations() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nbStreet").value(hasItem(DEFAULT_NB_STREET.toString())))
            .andExpect(jsonPath("$.[*].zipCode").value(hasItem(DEFAULT_ZIP_CODE.toString())))
            .andExpect(jsonPath("$.[*].longitute").value(hasItem(DEFAULT_LONGITUTE.toString())))
    ...
    public void getLocation() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations/{id}", location.getId()))
            ...
            .andExpect(jsonPath("$.nbStreet").value(DEFAULT_NB_STREET.toString()))
            .andExpect(jsonPath("$.zipCode").value(DEFAULT_ZIP_CODE.toString()))
            .andExpect(jsonPath("$.longitute").value(DEFAULT_LONGITUTE.toString()))
    ...
    public void updateLocation() throws Exception {
        ...
        updatedLocation
            ...
            .nbStreet(UPDATED_NB_STREET)
            .zipCode(UPDATED_ZIP_CODE)
            .longitute(UPDATED_LONGITUTE)
        ...
        assertThat(testLocation.getNbStreet()).isEqualTo(UPDATED_NB_STREET);
        assertThat(testLocation.getZipCode()).isEqualTo(UPDATED_ZIP_CODE);
        assertThat(testLocation.getLongitute()).isEqualTo(UPDATED_LONGITUTE);
